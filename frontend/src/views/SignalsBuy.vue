...
const ranked = computed(() =>
  [...store.todaySignals]
    .filter((s) => ['buy', 'strong_buy'].includes(s.latest_signal?.signal))
    .sort((a, b) => Number(b.latest_signal.score) - Number(a.latest_signal.score))
)
...
<template>
  <div>
    <h1>Buy Signals</h1>
    <p class="muted">Every stock currently flagged Buy or Strong Buy, ranked by score — highest conviction first. Not financial advice.</p>
